...
use App\Http\Requests\Api\EditPermissionRequest;
...
class PermissionController extends Controller
{
     ...
     */
    public function update(EditPermissionRequest $request, string $id)
    {
        $edit = $this->permissionRepository->update(new EditPermissionDTO(... [$id, ... $request->validated()]));
        if (!$edit) {
            return response()->json(['message' => 'Permission not found'], Response::HTTP_NOT_FOUND);
        }
